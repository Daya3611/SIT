...
export default function ContactPage() {
    return (
        <main className="relative min-h-screen bg-[#fdfdfb] selection:bg-[#7c9473] selection:text-white pt-1 pb-5">
            <NavBar />
            <CTASection />

            <div className="max-w-6xl mx-auto px-6 mt-10 mb-9">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-neutral-100 shadow-sm text-center">
                        ...
                        <h4 className="text-xl font-black text-[#2d3429] mb-2">hello@DBT-Connect.com</h4>
